...
<main id="primary" class="main-content cyclon_product_category_content">
    ...
    <section class="saloon new-category-landing">
        ...
        if (!$has_products_with_range) : ?>
            <!-- Simple version when has_product_range is false -->
            <div class="new-category-landing-no-tabs">
                <div class="primary text-center boxed-sm centered new-category-landing__dynamic-texts new-category-landing__dynamic-texts--no-tabs no-padding">
                    <?php
                    ...
                    ?>
                            ...
                            <div class="text-m">
                                <?php echo wpautop($cat_term->description); ?>
                            </div>
                    <?php
                        }
                    }
        ...
        <?php else : ?>
            ...
            <div>
                ...
                <!-- Full tabs system when has_product_range is true -->
        ...
        if ($associated_cat_id) {
            ...
            if ($has_products && $associated_cat_id != 778 && $associated_cat_id != 3394 && $associated_cat_id != 4125 && $associated_cat_id != 4128) {
    ...
    <?php if (!$has_products_with_range) : ?>
        <?php if ($associated_cat_id == 778 || $associated_cat_id == 3394 || $associated_cat_id == 4125 || $associated_cat_id == 4128) : ?>
            <!-- Special case: Subcategories Grid for category ID 778 (en) + 3394 (el) + 4125 (de) -->
